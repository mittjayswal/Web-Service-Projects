...
import org.mitt.jax.messager.exception.DatNotFoundException;
...
public class MessageService {
	...
	public MessageService() {
		messages.put(1L, new Message(1L, "Helloe Wold", "Mitt"));
		messages.put(2L, new Message(2L, "Helloe Wold", "Shivam"));
	}
	...
	public Message getMessage(long id) {
		...
		if (message == null) {
			throw new DatNotFoundException("Message with id "+id+ " not found");
		}
		return message;
	}
